...
public enum CommandType {
    ...
    RECEIVE_SUBSCRIPTION_PURCHASE_PERMISSION,
    GET_SUBSCRIPTION_PURCHASE_CONFIRMATION,
    RECEIVE_SUBSCRIPTION_PURCHASE_CONFIRMATION,

    GET_EXAM_PURCHASE_PERMISSION,
    RECEIVE_EXAM_PURCHASE_PERMISSION,
    GET_EXAM_PURCHASE_CONFIRMATION,
    RECEIVE_EXAM_PURCHASE_CONFIRMATION,

    USE_DIAMOND,

    LOG_COURSE_STEP_UP,
    LOG_COURSE_CHAPTER_PASS,
    ...
    GET_COURSE_CHAPTER_QUESTION,
    RECEIVE_COURSE_CHAPTER_QUESTION,
